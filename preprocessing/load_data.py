...
def load_raw_data(path_to_data_file, unfold=False):
    ...
    return features, labels, feature_to_index
...
# make a new feature matrix that only has categorical variables
def _discretize_continuous_features(features, num_classes_per_feature=10):
    for e, feature in enumerate(numerical_features):
        print '{} -- {}'.format(e, feature)
